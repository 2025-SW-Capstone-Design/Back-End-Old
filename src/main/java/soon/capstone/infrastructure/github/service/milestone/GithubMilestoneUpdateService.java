...
public class GithubMilestoneUpdateService {
    ...
    public void updateMilestone(String owner, String repo, int milestoneNumber, String oauthToken, String title, String description, LocalDateTime dueDate) {
        ...
        GithubMilestoneUpdateDto updateDto = GithubMilestoneUpdateDto.of(title, description, dueDate);
